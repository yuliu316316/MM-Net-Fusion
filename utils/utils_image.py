...
def augment_img_contrast(img, mode=0):
    ...
    if mode == 0:
        ...
        img[seed2_1:seed2_1 + seed1_1, seed2_2:seed2_2 + seed1_2, :] = np.clip(
            (np.array(img[seed2_1:seed2_1 + seed1_1, seed2_2:seed2_2 + seed1_2, :]) ** gamma), 0, 255).astype('uint8')
        return img
    elif mode == 2:
        ...
        img[seed2_1:seed2_1 + seed1_1, seed2_2:seed2_2 + seed1_2, :] = img[seed2_1:seed2_1 + seed1_1,
                                                                       seed2_2:seed2_2 + seed1_2, :] + noise
        return img
